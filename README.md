...
const greeting = {
  ...
  resumeLink: "https://drive.google.com/file/d/1DuuKqOKqGtiBVKwjLt6yLUJoYT7gT_u2/view"
};
...
```
#### Resume upload
To upload your own resume, simply upload a pdf to `src/containers/resume` and rename the pdf to `Your_name.pdf`. 
